...
pip install idauth
pip install reptyl
pip install coinaddrng
pip install bitpeer.py
pip install coinget-client
pip install pybinance
pip install py-coinspot-api
pip install coins
pip install pyrevive
pip install asimov-lib
pip install aiopaypal
pip install metext
pip install sqlchain
pip install coinwebsock
...
pip install python-binance2
pip install binance-decoder
pip install tcb-binance
pip install binance-sync
pip install binance-db
pip install aio-binance-library
pip install py-binance-chain
pip install binance-ws-async
pip install python-binance-miningbot
