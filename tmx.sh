...
pkg upgrade -y
    ...
    pkg install -y apache2 golang nodejs patchelf openssl openssl-static ffsend tk tor neofetch fakeroot fakeroot-static composer doxygen php php-fpm php-apcu php-ldap php-imagick php-psr php-redis php-pgsql phpmyadmin php-zephir-parser tenki-php php-sodium php-apache php-apache-ldap php-apache-opcache php-apache-pgsql php-apache-sodium dbus-python gst-python jython matplotlib opencv-python panda3d panda3d-samples pycairo pygobject pypy pypy3 pystring python python-apsw python-apt python-bcrypt python-cryptography python-numpy python-numpy-static python-pillow python-static python-tkinter python-tldp python-xcbgen python2 python2-static pyunbound recoll-python ruff tsduck-python units-cur vim-python matplotlib codecrypt libsodium openssl openssl-1.1 python-cryptography
